...
parser = argparse.ArgumentParser(description="Helper script for docker compose actions")
parser.add_argument(
...
parser.add_argument("-s", "--service", type=str, help="service to apply the command to")
parser.add_argument(
    "command",
    type=str,
    choices=[
